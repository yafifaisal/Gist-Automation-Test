...
WebUI.verifyElementPresent(findTestObject('Object Repository/Gist Edit/all_gist_tab'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/Gist Edit/first_gist_list'), "Edit Gist File Extension.txt")